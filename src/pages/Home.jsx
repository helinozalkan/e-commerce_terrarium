...
// FAZ 1 & 3: İçerikle Tam Uyumlu ve Kuruş Hassasiyetli Ürün Listesi
const mockProducts = [
  {
    id: 1,
...
const Home = () => {
  ...
  // ✅ Kod 2 mantığı: 5 saat sonrası için gerçek geri sayım
  ...
  // ✅ Renk uyumu için tek yerden yönetilecek yeşil tonları
  const GREEN = {
    primary: '#2d4a27',   // Kodun genelinde geçen koyu yeşil
    accent: '#a8d5ba',    // Hero üst yazıdaki açık yeşil
    success: '#198754',   // Bootstrap success uyumlu yeşil
  };
    ...
    <div style={{ backgroundColor: '#fcfdfc' }}>
      ...
      <div className="container-fluid p-0 position-relative" style={{ height: '85vh', overflow: 'hidden' }}>
        ...
        <div className="position-absolute top-50 start-50 translate-middle text-center text-white w-100">
          <h6 className="text-uppercase mb-3" style={{ letterSpacing: '5px', color: GREEN.accent }}>
          ...
          <a href="#shop" className="btn btn-outline-light btn-lg px-5 py-3 rounded-pill">
            Koleksiyonu Keşfet
          </a>
        </div>
      </div>
            ...
            <div key={urun.id} className="col-md-3">
              <div className="card h-100 border-0 shadow-sm rounded-4 overflow-hidden position-relative">
                ...
                <div className="position-relative overflow-hidden">
                  ...
                  {urun.stock === 0 && (
                    <div className="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center bg-dark bg-opacity-50 text-white fw-bold" style={{ zIndex: 3 }}>
                      TÜKENDİ
                    </div>
                  )}
                </div>
      ...
      {/* ✅ 4.5 BÖLÜM: GERİ SAYIM & İNDİRİM (MAVİ -> YEŞİL) */}
      <div className="container-fluid p-0 bg-dark mt-5" style={{ minHeight: '200px', height: 'auto' }}>
        <div className="row m-0">
          <div className="col-12 col-md-6 text-white p-5" style={{ fontWeight: 'bold', fontSize: '45px' }}>
            Seçili Ürünlerde %50'ye Varan İndirim
            <div>
              <a
                href="#shop"
                className="btn ms-2 text-white mt-3"
                style={{
                  backgroundColor: GREEN.primary,   // ✅ mavi yerine kodun yeşili
                  borderRadius: '20px',
                  height: '40px',
                  width: '140px'
                }}
          ...
          <div className="col-12 col-md-6 text-white p-5">
            <div className="d-flex justify-content-around">
              <div className="text-center">
                <div className="border rounded-3 px-4 py-3 fw-bold fs-3">{countdown.hours}</div>
                <div className="fs-5 mt-2">Saat</div>
              </div>
              <div className="text-center">
                <div className="border rounded-3 px-4 py-3 fw-bold fs-3">{countdown.minutes}</div>
                <div className="fs-5 mt-2">Dakika</div>
              </div>
              <div className="text-center">
                <div className="border rounded-3 px-4 py-3 fw-bold fs-3">{countdown.seconds}</div>
                <div className="fs-5 mt-2">Saniye</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="row justify-content-center">
          {[
            ...
            <div key={idx} className="col-md-3 text-center mb-4">
              ...
              {/* ✅ Ekibin rol rengi de kodun yeşil tonuna çekildi */}
              <p className="small fw-bold" style={{ color: GREEN.success }}>
                {person.role}
              </p>
            </div>
          ))}
